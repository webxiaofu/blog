<template>
  <div
    class="comment-item"
    :id="'comment'+childCommentItem._id"
  >
    <div class="avatar">
      <img
        v-lazy="childCommentItem.user.photo"
        class="box-image"
        alt=""
      >
    </div>
    <div class="comment-body">
      ...
      <div class="comment-foot clearfix">
        <span>{{childCommentItem.create_timestamp | dateChange}}</span>
        <span
          class="comment-reply"
        ...
        <span
          ...
          v-if="personalInfo.user._id===childCommentItem.uid"
          @click="deleteComment(childCommentItem._id,childCommentItem.parent_id)"
        >删除</span>
      </div>
    </div>
    ...
    <div
      ...
      v-if="isComment"
      :id="'comment-reply'+childCommentItem._id"
    >
      <comment-form
        :reply_uid="reply_uid"
        :child_comment_id="childCommentItem.parent_id"
        :aid="childCommentItem.aid"
